...
var RunService = require('./run');

module.exports = function(version, target, silent, callback) {
  ...
  mkdirp(destinationDir, function(err) {
    ...
    if(fileName != null) {
      ...
      download(version, destinationDir, fileName, function(err, file){
        if(err) {
          return callback(err, file);
        }

        install(file, target, silent, callback);
...
function install(file, target, silent, callback) {
